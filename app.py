        ...
        with st.chat_message("model", avatar="🤖"):
            ...
            try:
                ...
                if kb_content:
                    ...
                    1.ตอบตรงเนื้อหาและการยกตัวอย่างต้องครบถ้วนตรงตาม knowledge_base 100% และไม่ต้องอ้างอิงเลขหน้าของเนื้อหา
                    2.หากไม่มีข้อมูลในเอกสาร ให้ตอบว่า "ขออภัยครับ ข้อมูลส่วนนี้น้อง C ยังไม่ได้เรียนรู้มาเลยครับ"
                    3.ห้ามตอบนอกเหนือจากเอกสารนี้เด็ดขาด:
                    """
